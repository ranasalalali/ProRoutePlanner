...
import {addBusWayPoint,getWaypointList,addBusEndPoint,getSearchPredictions,getSearchInput,getSelectedRegion} from '../actions';
...
class EndPointMap extends Component{
  ...
  AddEndpoint(){
    ...
    this.props.addBusEndPoint(this.state.marker);
  }
  ...
  handleSelectedAddress(placeID){
    ...
    this.setState({ x:{latitude:this.props.selectedregion.latitude,
                        longitude:this.props.selectedregion.longitude,
                        latitudeDelta:0.0045,
                        longitudeDelta:0.0045 },marker:{latitude:this.props.selectedregion.latitude,
                                            longitude:this.props.selectedregion.longitude,
                                            latitudeDelta:0.0045,
  ...
  render (){
    return(
      <Container>
        ...
        <Button full dark onPress={()=>this.AddEndpoint()}>
          <Icon name='add' />
          <Text>Add</Text>
        </Button>
        ...
        <MapView
          ...
          region={{latitude:this.props.selectedregion.latitude,
                  longitude:this.props.selectedregion.longitude,
                  latitudeDelta:0.0045,
                  longitudeDelta:0.0045 }}
        >
...
export default connect(mapStateToProps,{addBusWayPoint,getWaypointList,addBusEndPoint,getSearchPredictions,getSearchInput,getSelectedRegion})(EndPointMap);
