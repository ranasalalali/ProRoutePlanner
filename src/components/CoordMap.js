...
class CoordMap extends Component{
  ...
  handleSelectedAddress(placeID){
    ...
    this.setState({ place:placeID,
                    x:{latitude:this.props.selectedregion.latitude,
                        longitude:this.props.selectedregion.longitude,
                        latitudeDelta:0.0045,
                        longitudeDelta:0.0045 },
                    marker:{latitude:this.props.selectedregion.latitude,
                        longitude:this.props.selectedregion.longitude,
                        latitudeDelta:0.0045,
                        longitudeDelta:0.0045 }});
  }
    ...
    return(
      <Container>
        ...
        <MapView
          ...
          initialRegion={{latitude: 24.8615,
          longitude: 67.0099,
          latitudeDelta: 0.0922,
          longitudeDelta: 0.0421,}}
