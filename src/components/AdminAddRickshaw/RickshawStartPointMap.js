...
class RickshawStartPointMap extends Component {
  constructor(props) {
    super(props);
    this.state = {
      place: '',
  ...
  AddStartpoint() {
    if (this.state.place === '') {
      ...
      this.props.addRickshawStartPoint(this.state.place);
    }
  }
...
export default connect(mapStateToProps, { addRickshawWayPoint, getRickshawWaypointList, addRickshawStartPoint, getSearchPredictions, getSelectedRegion, getSearchInput })(RickshawStartPointMap);
